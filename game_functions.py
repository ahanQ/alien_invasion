...
def check_keydown_events(event, ai_settings, screen, stats, sb, ship, aliens, bullets):
	...
	if event.key == pygame.K_LEFT:
		...
		play(ai_settings, screen, stats, sb, ship, aliens, bullets)
...
def play(ai_settings, screen, stats, sb, ship, aliens, bullets):
	"""如果游戏未处于活动状态则开始游戏"""
...
def update_aliens(ai_settings, stats, sb, screen, ship, aliens, bullets):
	...
	# 检测外星人和飞船之间的碰撞或者是否有外星人到达屏幕底端
	if pygame.sprite.spritecollideany(ship, aliens) or check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets):
